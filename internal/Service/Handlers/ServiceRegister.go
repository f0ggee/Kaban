...
func (sa *HandlerPackCollect) RegisterService(de *Dto.UserDataRegister) (string, string, error) {
...
func GenerateScrypt(de *Dto.UserDataRegister, err error) (string, error) {
	salt := make([]byte, 16)
