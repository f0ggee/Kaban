...
2)Then we generate a hash and sign it by master server's key. This added so that a server which will get a packet make sure it from the Master server truly 
